        ...
        <PaperView>
          ...
          <div className="sub-section-header">2.3 Vehicle/s Involved</div>
            <SectionBody>
              ...
              {
                (!incident.involved_vehicle_motorcycle && 
                !incident.involved_vehicle_hatchback && 
                !incident.involved_vehicle_sedan && 
                !incident.involved_vehicle_suv && 
                !incident.involved_vehicle_van && 
                !incident.involved_vehicle_pickup) && ("NOT FOUND")
              }
            </SectionBody>
          <div className="sub-section-header">2.4 Place of Incident</div>
          <SectionBody>
            <Field label="Region" status={status} text={Help.displayText(incident.region)}  />
            <Field label="Province" status={status} text={Help.displayText(incident.province)}  />
